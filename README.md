...
<b><br>Data Engineering	:</b> Data Pipelines, ETL, Cloud Data Processing (AWS, Azure), Airflow, Google Analytics  
<b><br>Programming Language :</b> Python, JavaScript, SQL, HTML/CSS, PL/SQL  
<b><br>Project Management :</b> Scrum Methodologies, Agile Frameworks, Collaboration Tools (Jira, Confluence, Git, Artifactory)  
...
<ul>
    ...
    <li>Tableau Essential Training, LinkedIn</li>
   <li>Jira Fundamentals, Atlassian</li>
